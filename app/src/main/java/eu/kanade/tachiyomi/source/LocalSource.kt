...
class LocalSource(
    ...
    companion object {
        ...
        fun getImportDirectory(context: Context): File? {
            val dir = getBaseDirectories(context).firstOrNull() ?: return null
            return if ((dir.exists() || dir.mkdirs()) && dir.isDirectory) dir else null
        }
