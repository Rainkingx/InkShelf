        ...
        inner class ThemeItem(
            ...
            inner class ViewHolder(
                ...
                override fun bindView(
                    ...
                    if (item.theme == Themes.MODERN_LIBRARY && item.isDarkTheme) {
                        binding.themeToolbar.background =
                    ...
                    binding.themeAccentedButton.imageTintList = ColorStateList.valueOf(colorPrimary)
                    ...
                    binding.themeItem3.imageTintList =
                        ColorStateList.valueOf(inactiveTab)
                    if (item.theme == Themes.MODERN_LIBRARY && item.isDarkTheme) {
                        binding.themeLayout.background =
                            ContextCompat.getDrawable(context, R.drawable.modern_library_theme_background)
                    } else {
