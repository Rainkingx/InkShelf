...
class PreferencesHelper(
    ...
    fun nightMode() = flowPrefs.getInt(Keys.nightMode, AppCompatDelegate.MODE_NIGHT_YES)

    fun themeDarkAmoled() = flowPrefs.getBoolean(Keys.themeDarkAmoled, true)
    ...
    fun darkTheme() = flowPrefs.getEnum(Keys.darkTheme, Themes.LAVENDER)
    ...
    fun panelFlowEnabled() = flowPrefs.getBoolean("inkshelf_panel_flow_enabled", false)
    ...
    fun libraryLayout() = flowPrefs.getInt(Keys.libraryLayout, LibraryItem.LAYOUT_COMPACT_GRID)
