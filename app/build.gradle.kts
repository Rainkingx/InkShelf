...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "COMMIT_COUNT", "\"1\"")
        buildConfigField("String", "BETA_COUNT", "\"01\"")
        buildConfigField("String", "COMMIT_SHA", "\"nogit\"")
...
dependencies {
    ...
    // InkShelf Panel Flow: bundled on-device OCR (works offline immediately)
